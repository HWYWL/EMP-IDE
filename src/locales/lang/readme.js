export default `
    ...
    YI MicroPython for Easy MicroPython (EMP) is an open source project led by 1ZLAB 
    to provide a faster and more efficient development experience 
    for MicroPython enthusiasts.

    GitHub:   https://github.com/HWYWL/EMP-IDE
    ...
    the yi-mp module on your MicroPython device. Please follow 
    ...
    YI MicroPython 来自于 Easy MicroPython (EMP), 是一个由1Z实验室主导的开源项目，旨在为广大的
    ...
    在开始使用之前，你需要在你的MicroPython设备上安装 yi-mp 模块。请按
    照如下的步骤进行：
    ...
    自动开启，默认的连接密码为'123456', 你可以在 webrepl.pass 文件中修改它。
`
